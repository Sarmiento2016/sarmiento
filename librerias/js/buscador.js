...
function agrega_a_reglon(este,texto,cantidad, bandera){
	...
	if(bandera){
		...
		$('#reglon_factura').append('<div id="cont_borra'+este+'" class="cont_reglon_item_presup row" style="padding-left: 15px"><span class="item_reglon col-md-7" id='+este+' >'+texto+'</span>		<input class="cant_item_reglon col-md-1" id=cant_'+este+' onchange="mod_cant(this)" value='+cantidad+'>		<input class="px_item_reglon col-md-1" id=px_'+este+' value='+px_unitario+'>		<input class="px_reglon col-md-2" id=px_x_cant'+este+' value='+px_reglon+'> <div class="col-md-1"><button title="Borrar linea" class="ico_borra btn btn-danger btn-xs pull-left" onclick="borra_reglon('+este+')" id="ico_borra'+este+'"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></div></div>');
