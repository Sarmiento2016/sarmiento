...
/*	function devoluciones(cliente){
        var parametros = {
                    "cliente" : cliente
        };
        $.ajax({
                data:  parametros,
                url:   'search_devolucion.php',
                type:  'post',
				dataType: "json",
                beforeSend: function () {
                        $("#resultado").html("Consultado devoluciones, espere por favor...");
                },
                success:  function (response) {
						...
						$.each(response, function(i, item) {
							...
							$("#reglon_devoluciones").append("<span class='col-xs-1'>"+item.id+"</span>");
							$("#reglon_devoluciones").append("<span class='col-xs-2'>"+item.fecha+"</span>");
							$("#reglon_devoluciones").append("<span class='col-xs-1'>"+item.monto+"</span>");
							$("#reglon_devoluciones").append("<span class='col-xs-1'>"+item.a_cuenta+"</span>");
							$("#reglon_devoluciones").append("<span class='col-xs-4'>"+item.nota+"</span>");
							$("#reglon_devoluciones").append("<span class='col-xs-3'>Asignar</span>");	
